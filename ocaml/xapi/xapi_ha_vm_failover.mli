...
val plan_for_n_failures : __context:Context.t -> all_protected_vms:(HA_VM.t list) -> ?change:configuration_change -> int -> result

(** Compute the maximum plan size we can currently find *)
val compute_max_host_failures_to_tolerate : __context:Context.t -> ?protected_vms:(HA_VM.t list) -> unit -> int64

...
val assert_vm_placement_preserves_ha_plan : __context:Context.t -> ?leaving:(API.ref_host * VMResources.t) list -> ?arriving:(API.ref_host * VMResources.t) list -> unit -> unit
...
val assert_new_vm_preserves_ha_plan : __context:Context.t -> VMResources.t -> unit
